...
<p align="center">
  <a href="docs/skills-catalog.zh-CN.md"><img alt="16 个精选 Skills" src="https://img.shields.io/badge/COLLECTION-16_SKILLS-0B1F3A?style=for-the-badge"></a>
...
仓库目前收录 16 个可跨项目独立使用的 skills，分为三类。端到端写作工作流 skills
...
| 工具与集成 | 4 | 可复用 CLI、文档抓取、联网搜索与开发者磁盘审计 |
