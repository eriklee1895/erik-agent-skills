...
<p align="center">
  <a href="docs/skills-catalog.zh-CN.md"><img alt="26 个精选 Skills" src="https://img.shields.io/badge/COLLECTION-26_SKILLS-0B1F3A?style=for-the-badge"></a>
...
仓库目前收录 26 个 skills，分为四类：

| 分类 | 数量 | 能力范围 |
| --- | ---: | --- |
| 写作 | 4 | 选题构思、文章润色、发布前检查与任务收尾 |
| 发布与渠道 | 9 | 微信公众号、博客、Notion 与飞书工作流 |
