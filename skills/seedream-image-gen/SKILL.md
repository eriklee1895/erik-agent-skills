...
description: >
  ...
  imagery, data explainers / infographic posters, character-consistent
  series, parody WeChat/iOS UI mockups for jokes, or modify existing images
  with title/object swaps and local edits.
---
