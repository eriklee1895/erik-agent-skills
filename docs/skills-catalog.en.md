...
| [live-avatar-3d](../skills/live-avatar-3d/) | Turn a character image into a no-build interactive 3D browser avatar with orbit, gestures, and optional local microphone mouth motion. | `npx skills add eriklee1895/erik-agent-skills --skill live-avatar-3d` |
