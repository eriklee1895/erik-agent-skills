...
| [feishu-whiteboard-diagram](../skills/feishu-whiteboard-diagram/) | Insert editable, document-quality architecture and process diagrams into Feishu Docx as native whiteboards (SVG / DSL / Mermaid), not screenshots or HTML5. | `npx skills add eriklee1895/erik-agent-skills --skill feishu-whiteboard-diagram` |
